 ...
 */
public abstract class Hilt_CustomerWiseItemAndRateDetilsFragment<T extends ViewDataBinding, V extends BaseViewModel> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerWiseItemAndRateDetilsFragment_GeneratedInjector) this.generatedComponent()).injectCustomerWiseItemAndRateDetilsFragment(UnsafeCasts.<CustomerWiseItemAndRateDetilsFragment>unsafeCast(this));
    }
  }
