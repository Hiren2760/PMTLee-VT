 ...
 */
public abstract class Hilt_HardeningVacuumFragment<T extends ViewDataBinding, V extends BaseViewModel> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HardeningVacuumFragment_GeneratedInjector) this.generatedComponent()).injectHardeningVacuumFragment(UnsafeCasts.<HardeningVacuumFragment>unsafeCast(this));
    }
  }
