 ...
 */
public abstract class Hilt_WeightmentFragment<T extends ViewDataBinding, V extends BaseViewModel> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WeightmentFragment_GeneratedInjector) this.generatedComponent()).injectWeightmentFragment(UnsafeCasts.<WeightmentFragment>unsafeCast(this));
    }
  }
