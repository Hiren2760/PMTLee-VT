 ...
 */
public abstract class Hilt_MaterialInwardFragment<T extends ViewDataBinding, V extends BaseViewModel> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MaterialInwardFragment_GeneratedInjector) this.generatedComponent()).injectMaterialInwardFragment(UnsafeCasts.<MaterialInwardFragment>unsafeCast(this));
    }
  }
