 ...
 */
public abstract class Hilt_HardeningProcessFragment<T extends ViewDataBinding, V extends BaseViewModel> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HardeningProcessFragment_GeneratedInjector) this.generatedComponent()).injectHardeningProcessFragment(UnsafeCasts.<HardeningProcessFragment>unsafeCast(this));
    }
  }
