 ...
 */
public abstract class Hilt_BatchScheduleFragment<T extends ViewDataBinding, V extends BaseViewModel> extends BaseFragment<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BatchScheduleFragment_GeneratedInjector) this.generatedComponent()).injectBatchScheduleFragment(UnsafeCasts.<BatchScheduleFragment>unsafeCast(this));
    }
  }
