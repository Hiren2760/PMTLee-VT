...
class CustomerInfoRateDetailsAdapter (ctx: Context, fontList: ArrayList<CustomerInformationModel>) : ArrayAdapter<CustomerInformationModel>(ctx, 0, fontList) {
    ...
    private fun createItemView(position: Int, recycledView: View?, parent: ViewGroup): View {
        ...
        materialLocationData?.let {
            view.itemTV.text =materialLocationData.customerOrganisationName
        }
